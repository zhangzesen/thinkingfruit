...
<div style="margin-top: 20px;" class="layui-tab layui-tab-brief">
    <ul class="layui-tab-title" style="margin-left: 10px;">
			...
			<li class="layui-this"><a href="<%=%>/count/countCommentGrade">评价统计</a></li>
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="firstCategory" lay-filter="firstCategory"
							lay-verify="">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="secondCategory" lay-filter="secondCategory"
							lay-verify="">
							<option value="">请选择</option>
						</select>
					</div>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="commodity" lay-filter="commodity" lay-verify="">
							<option value="">请选择</option>
						</select>
					</div>
				</div>
...
<%-- 	<jsp:include page="/context/js-tags.jsp" /> --%>
	...
	<script type="text/javascript" src="<%=%>/plug-in/js/count/countCommentGrade.js"></script>
</body>
</html>