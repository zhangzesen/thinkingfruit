...
<body>
	<div class="layui-tab layui-tab-brief main-tab-container">
		<div class="layui-tab-content">
			...
			<a href="<%=basePath%>/order/export"  class="layui-btn layui-btn-danger btn-export-excel" name="exportExcel"><i class="layui-icon">&#xe601;</i> 导出当前页面的Excel</a>
			</xblock>
			<!-- 表格 -->
            <div id="dateTable" lay-filter="table-data"></div>
			<script type="text/html" id="barOption">
			<a class='layui-btn layui-btn-small layui-btn-warm look_btn' lay-event='detail'  title='查看' ><i class='layui-icon'>&#xe615;</i></a>
			<a class='layui-btn layui-btn-small layui-btn-normal add_btn' lay-event='deliver'  title='发货' ><i class='layui-icon'>&#xe657;</i></a>
    		<a class="layui-btn layui-btn-small cancel_btn" lay-event="cancel"  title='取消' ><i class='layui-icon'>&#xe640;</i></a>
			</script>
